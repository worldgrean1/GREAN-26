...
export default function LandingPage() {
  ...
  return (
    <div 
      className={`relative min-h-screen min-h-[100dvh] w-screen overflow-hidden ${
        isDark ? 'bg-[#020617]' : 'bg-white'
      }`}
      style={{
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {isLoading && (
          ...
          >
            <div className={`flex flex-col items-center ${isDark ? 'bg-[#020617]' : 'bg-white'}`}>
              {/* Animated Logo */}
              <motion.div
              ...
              {/* Company Name */}
              <motion.div
                className={`text-center ${isDark ? 'bg-[#020617]' : 'bg-white'}`}
              ...
              >
                ...
                <p className={`text-xl leading-relaxed tracking-wide ${isDark ? 'text-slate-300' : 'text-black'}`}>
              ...
              {/* Loading Text */}
              <motion.p
                className={`mt-6 text-lg ${isDark ? 'text-gray-400' : 'text-gray-500'}`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
      ...
      {loadingComplete && (
        <motion.div
          className={`relative z-10 ${isDark ? 'bg-[#020617]' : 'bg-white'}`}
          style={{
            background: isDark ? '#020617' : '#ffffff',
          }}
          initial={{ opacity: 0 }}
              ...
              >
                <AnimatePresence>
                  {inverterActive && !booting && (
                    ...
                    >
                      <div className={shouldShowMobileLayout ? "text-center p-4" : "flex flex-col items-center text-center px-4"}>
                        <h1 className={shouldShowMobileLayout 
                          ? `text-lg font-bold tracking-tight mb-2 flex items-center justify-center ${
                            isDark ? 'text-white' : 'text-slate-800'
                          }`
                          : `text-6xl md:text-7xl lg:text-8xl font-black leading-none tracking-tight mb-2 flex flex-col sm:flex-row items-center justify-center gap-2 ${
                            isDark ? 'text-white' : 'text-slate-800'
                          }`}>
                          <span className="inline-block">
                            <TypingTextAnimation
                              ...
                              speed="medium"
                            />
                            {shouldShowMobileLayout && <span className="inline-block w-1 h-4 bg-green-400 ml-1"></span>}
                          </span>
                          <svg
                            ...
                            className={shouldShowMobileLayout
                              ? "lucide lucide-zap w-4 h-4 ml-1 text-green-500"
                              : `lucide lucide-zap w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 ${
                        ...
                        <p className={shouldShowMobileLayout
                          ? `text-xs leading-relaxed ${isDark ? 'text-gray-300' : 'text-slate-700'}`
                          : `text-xl leading-relaxed max-w-3xl mx-auto mb-2 ${
                    ...
                    <div className={`hidden sm:flex lg:hidden justify-end ${
                      ...
                      <div className="fixed right-2 top-1/2 transform -translate-y-1/2 z-20">
                        <GreanCard pattern="dots" gradient className={`relative backdrop-blur-sm shadow-xl p-3 overflow-hidden w-48 max-h-[80vh] overflow-y-auto ${
                          ...
                          {/* Background accent elements for tablet */}
                          <div className={`absolute -bottom-16 -right-16 w-32 h-32 rounded-full ${
                            isDark ? 'bg-[#3DD56D]/10' : 'bg-[#2bb757]/20'
                          }`}></div>
                          <div className={`absolute -top-16 -left-16 w-24 h-24 rounded-full ${
                            isDark ? 'bg-[#3DD56D]/10' : 'bg-[#2bb757]/20'
                          }`}></div>

                          {/* Vertical contact card content */}
                          ...
                          <div className="flex flex-col items-center space-y-3">
                            ...
                            <div className="w-full space-y-2 text-xs">
                              <div className="text-center">
                                ...
                                <div className={`font-medium ${isDark ? 'text-gray-300' : 'text-[#2bb757]/80'}`}>
                                  sileshi@greanworld.com
                                </div>
                                <div className={`font-medium ${isDark ? 'text-gray-300' : 'text-[#2bb757]/80'}`}>
                                  Addis Ababa, Ethiopia
